...
Las PyMEs no necesitan "marketing", "tecnología" o "automatización" como categorías sueltas. Necesitan **escalar su negocio** sin que se les caiga la operación.
...
- eXcalando construye **puentes** entre las 4 capas → todo conectado, todo fluye
- Eso es lo que significa la **X** de eXcalando: el cruce, el puente, la unión
...
| Servicio | Precio | Qué hace |
|---|---|---|
| Automatización a Medida (Simple) | Desde $800K setup | Conecta 1-2 herramientas, flujos básicos |
| Automatización a Medida (Intermedia) | Desde $2M setup | 3-5 herramientas + lógica |
| Automatización a Medida (Compleja) | Desde $5M setup | Ecosistemas + agentes IA + dashboards |
...
|---|---|---|
| Dashboards Metabase personalizados | ⏳ pendiente subdomain | Tablero de control de tu negocio |
| Calificación automática de leads | ⏳ V2 (mes 4-6) | Lead Qualification Agent |
| Reportes mensuales automáticos | ⏳ V2 (mes 4-6) | Reporting Agent |
| Alertas inteligentes por canal | ✅ ya en Alertas | Las alertas del bot llegan al humano |
| Decisiones con datos, no a ojo | ✅ base lista | Métricas en `mensajes_analisis` |

**Incluido en:** todos los Paquetes Integrales (Despegue, Crecimiento, Ventas Pro, Transformación).

---

## Cómo se comunica a clientes
